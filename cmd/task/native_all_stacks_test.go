...
func TestPrepareNativeAllStacksFixtureIsCredentialFreeAndComplete(t *testing.T) {
	...
	for _, call := range []string{"Install-AndroidStack", "Install-CppStack", "Install-DotNetStack", "Install-GoStack", "Install-HerdrStack", "Install-JavaStack", "Install-NSISStack", "Install-Uv", "Install-NodeStack", "Install-PlaywrightCLIStack", "Install-TradingViewStack"} {
