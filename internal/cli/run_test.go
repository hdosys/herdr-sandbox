...
func TestRunPrintsHelp(t *testing.T) {
	...
	for _, required := range []string{
		...
		"no overall timeout unless --timeout is supplied", "workspaceDiscovery", "named folder mounts", "wingetPackages", "audio (output)", "audioInput (microphone)", "tailscale", "mobileSSHAuthorizedKeys", "playwright-cli", "python-ai", "tradingview",
	} {
