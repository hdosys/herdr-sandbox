...
const (
	...
	InstallDirectoryName     = "Herdr Sandbox"
	Publisher                = "hdosys"
	ProductURL               = "https://github.com/hdosys/herdr-sandbox"
	ProductGUID              = "f845ea2a-ff3f-465b-95fa-49b1baf63b17"
	UninstallKeyName         = "{F845EA2A-FF3F-465B-95FA-49B1BAF63B17}"
	InstallerMarkerName      = ".herdr-sandbox-installation.json"
	QuietUninstallHelperName = ".herdr-sandbox-uninstall.ps1"
